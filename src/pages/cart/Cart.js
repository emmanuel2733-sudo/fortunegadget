...
import {ADD_TO_CART, CLEAR_CART, CALCULATE_SUBTOTAL, CALCULATE_TOTAL_QUANTITY, DECREASE_CART, REMOVE_FROM_CART, selectCartItems,  selectCartTotalAmount,
  selectCartTotalQuantity, 
  SAVE_URL} from '../../redux/slice/cartSlice';
   ...
   const checkout =() => {
    ...
    <section>
      <div className={`container ${styles.table}`}>
        ...
        {cartItems.lenght === 0 ? (
            <>
            <p>Your cart is currently empy.</p>
            <br></br>
            <div>
